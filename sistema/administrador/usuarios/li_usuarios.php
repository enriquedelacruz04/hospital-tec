            ...
            <?php do{?>
				<tr>
    				...
    				<td><input type="image" src="../images/icn_edit.png" title="EDITAR" onclick="aparecermodulos('administrador/fc_usuarios.php?id=<?php echo $rows['idempresasusuarios'];?>','main')">
                    	<input type="image" src="../images/icn_trash.png" title="ELIMINAR" onclick="BorrarDatos('<?php echo $rows['idusuarios'];?>','idusuarios','usuarios','n','administrador/vi_usuarios.php','main')">
                    </td> 
				</tr>
