...
{
	//alert(imagen);
	//$("#"+imagen).html('<div><img src="images/loading.gif" alt="" /><br />Cargando...</div>');		
	setTimeout(function(){
				  $.ajax({
					  type: 'POST',
...
{
	console.log(pagina);
	$("#"+donde).html('<div align="center" class="mostrar"><img src="images/loading.gif" alt="" /><br />Cargando...</div>');		
	setTimeout(function(){
				  $.ajax({
					  type: 'GET',
					  url: pagina,					  
...
function cargarestados()
{
	...
	$.ajax({
		  type: "POST",
	      url: "catalogos/ciudad/lista_estado.php",	   
		  data: 'idpais='+idpais,
	      success: function(msj)	 
					 {		
				       lista.append(msj);
...
function mostrarImagen(donde,tipo,id)
{
		...
		$("#"+donde).html('<div align="center" style="height:'+height+'; border-radius:5px; margin-left:10px; width:'+width+'; background: #E0E0E3 url(../images/sidebar.png) repeat"><img style="padding-top:35px; border-radius:5px" src="images/loading.gif" alt="" /><br />Cargando...</div>');		
	setTimeout(function(){
				  $.ajax({
					  type: 'POST',
...
function buscarPedido(formulario)
{
	...
	$("#li_pedidos").html('<div align="center" class="mostrar"><img src="images/loading.gif" alt="" /><br />Cargando...</div>');	
...
function buscarclientes(formulario)
{
	...
	$("#contenedor-clientes").html('<div align="center" class="mostrar"><img src="images/loading.gif" alt="" /><br />Cargando...</div>');	
	
	$.ajax({
			  type: 'POST',
			  url: 'catalogos/clientes/bu_clientes.php',
			  data: cadena,
			  cache:false,
			  success:function(msj){
...
function buscarclientes2(idclientes)
{
	//alert ("entro a buscarPedido");
	
	var cadena = "idclientes="+idclientes;
...
function buscarCaja(formulario)
{
	console.log("entro a buscar caja");
	var cadena = ObtenerDatosFormulario(formulario);
