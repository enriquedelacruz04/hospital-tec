        ...
        <?php
            ...
            <?php do{?>
				<tr> 
    				...
    				<td><?php echo $fu->imprimir_cadena_utf8(strtoupper($rows['est']));?></td> 
    				<td><input type="image" src="../images/icn_edit.png" title="EDITAR" onclick="aparecermodulos('administrador/modulos/fc_perfiles.php?id=<?php echo $rows['idusuarios'];?>','main')">
                    	<input type="image" src="../images/icn_trash.png" title="ELIMINAR" onclick="BorrarUsuario('<?php echo $rows['idusuarios'];?>')">
                    </td> 
				</tr>
