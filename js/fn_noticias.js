...
function guardarNoticias(formulario, archivoEnvio, archivoVizualizar, dondeMostrar) {
    let datosValidar = [{ REQUERIDO: "viTitulo" }, { REQUERIDO: "viAutor" }];
...
function borrarSecciones(id, campo, tabla, tipo, archivoVizualizar, dondeMostrar) {
