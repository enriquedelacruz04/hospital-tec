...
function guardarServiciosCoach(formulario, archivoEnvio, archivoVizualizar, dondeMostrar) {
    let datosValidar = [{ REQUERIDO: "viTitulo" }, { REQUERIDO: "viDescripcion" }];
...
function borrarServiciosCoach(id, campo, tabla, tipo, archivoVizualizar, dondeMostrar) {
