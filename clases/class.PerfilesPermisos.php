...
class PerfilesPermisos
{
	...
	public function Perfiles_Permisos($permiso)
	{
		$query_menu="INSERT INTO perfiles_permisos(idperfiles,idmodulos_menu)VALUES($this->ultimoperfil,$permiso)";
